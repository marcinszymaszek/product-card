  ...
  <div class="product-form-container">
    <form id="app" @submit="checkForm">
      ...
      <label class="btn-macrophoto active" title="szary">
        <input type="checkbox" name="color" id="color" v-model="colorDefault" />
      ...
      <div class="size-buttons">
        <label
          ...
          :key="size.sizeName"
        >
          <input type="checkbox" name="sizeXs" id="sizeXs" v-model="size.sizeName" />
          {{size.sizeName}}
        </label>
...
export default {
  data() {
    return {
      ...
      //     const els = sizesArray.map(size => {
      //       return (this.sizes.sizeName = size.value);
      //     });
