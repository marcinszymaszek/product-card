...
export default {
  ...
  methods: {
    ...
    checkForm: function(e) {
      ...
      if (!this.color && !this.size) this.error = "Proszę wybrać kolor oraz rozmiar";
      if (!this.color) this.error = "Proszę wybrać kolor";
      if (!this.size) this.error = "Proszę wybrać rozmiar";
      e.preventDefault();
    }
  }
};
